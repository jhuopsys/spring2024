...
Locate the earliest commit that was part of your work on Assignment 2, then
...
the hash of the first Assignment 2 commit was `2a096d98`, and the hash of the
commit before it was `42113d80`, so `42113d80` was my "base commit".
...
<div class='highlighter-rouge shell'><pre>
curl -O https://jhuopsys.github.io/spring2024/assign/create_submission_a2.sh
...
Welcome to the 'OS Assignment 2' submission script.
...
Please enter the base commit: <b>42113d80</b>
